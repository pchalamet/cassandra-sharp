...
namespace cqlplus.Parser
{
    ...
    public partial class ParseNode
    {
        ...
        {
            return new cqlplus.Commands.ShellCommand((string)this.GetValue(tree, TokenType.Identifier, 0), (Dictionary<string, string>)this.GetValue(tree, TokenType.Parameters, 0));
        }

        protected virtual object EvalCqlCommand(ParseTree tree, params object[] paramlist)
        {
            return new cqlplus.Commands.CqlStatement((string)this.GetValue(tree, TokenType.EVERYTHING_BUT_START_WITH_BANG, 0));
        }
